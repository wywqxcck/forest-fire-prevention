...
* @{
*/
#define PRODUCT_KEY "7f6404156dfe46b09cd2379b9a908f7d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "25cf05b87dc645bd985c257ad4882000"
...
* @{
*/
#define A_F_BYTEOFFSET                    0
#define A_F_BITOFFSET                     0
#define A_F_LEN                           1
#define A_MQ_BYTEOFFSET                    0
#define A_MQ_BITOFFSET                     1
#define A_MQ_LEN                           1
#define B_F_BYTEOFFSET                    0
#define B_F_BITOFFSET                     2
#define B_F_LEN                           1
#define B_MQ_BYTEOFFSET                    0
#define B_MQ_BITOFFSET                     3
#define B_MQ_LEN                           1

#define A_temp_RATIO                         1
#define A_temp_ADDITION                      0
#define A_temp_MIN                           0
#define A_temp_MAX                           100
#define A_Humidity_RATIO                         1
#define A_Humidity_ADDITION                      0
#define A_Humidity_MIN                           0
#define A_Humidity_MAX                           100
#define B_temp_RATIO                         1
#define B_temp_ADDITION                      0
#define B_temp_MIN                           0
#define B_temp_MAX                           100
#define B_Humidity_RATIO                         1
#define B_Humidity_ADDITION                      0
#define B_Humidity_MIN                           0
#define B_Humidity_MAX                           100
#define A_CO2_RATIO                         1
#define A_CO2_ADDITION                      0
#define A_CO2_MIN                           0
#define A_CO2_MAX                           5000
#define A_PM_RATIO                         1
#define A_PM_ADDITION                      0
#define A_PM_MIN                           0
#define A_PM_MAX                           1000
#define B_CO2_RATIO                         1
#define B_CO2_ADDITION                      0
#define B_CO2_MIN                           0
#define B_CO2_MAX                           5000
#define B_PM_RATIO                         1
#define B_PM_ADDITION                      0
#define B_PM_MIN                           0
#define B_PM_MAX                           1000
/**@} */
...
typedef struct {
    ...
    bool valueB_F;
    bool valueB_MQ;
    uint32_t valueA_temp;
    uint32_t valueA_Humidity;
    uint32_t valueB_temp;
    uint32_t valueB_Humidity;
    uint32_t valueA_CO2;
    uint32_t valueA_PM;
    uint32_t valueB_CO2;
    uint32_t valueB_PM;
...
typedef struct {
    ...
    uint8_t valueA_temp;
    uint8_t valueA_Humidity;
    uint8_t valueB_temp;
    uint8_t valueB_Humidity;
    uint16_t valueA_CO2;
    uint16_t valueA_PM;
    uint16_t valueB_CO2;
    uint16_t valueB_PM;
